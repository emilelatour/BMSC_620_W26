...
|	:---:	|	:---:	|	:---:	|	:---:	|
|	0	|	`{r} format(hw0, '%m/%d')`	|	[HW 00 files (OneDrive)](https://ohsuitg-my.sharepoint.com/:f:/g/personal/latour_ohsu_edu/IgAXMPuK4j5SSJBZciZj4Y96AR5OPvyfcNNzTxSL16n8UQQ?e=sQSOR5)	|	[View HW 00](docs/homework/HW00/HW00.qmd)	|
|	1	|	`{r} format(hw1, '%m/%d')`	|	(to be posted)	|	(to be posted)	|
