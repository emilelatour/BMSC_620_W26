...
- Click the **Insert Code Chunk** button (![](/img_slides/code_chunk_insert_icon.png)) at top right of the editor window
...
- Place the cursor on a line and click the **Run** button (![](/img_slides/01_Script_Run.png))
