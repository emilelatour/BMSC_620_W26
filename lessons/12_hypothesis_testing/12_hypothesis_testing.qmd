...
-   If 66 inches is in the interval → plausible
...
<!-- Is there more recent data than 1992? -->
...
-   We call 98.6 the "null value" and often write it as $\mu_0$
...
-   That's the significance level $\alpha$ (set in advance)
...
## Manual calculation with summary statistics
...
→ We reject $H_0$ at level $\alpha$
:::

::: {.column width="50%"}
**If the $(1-\alpha)×100\%$ CI DOES contain** $\mu_0$:

→ We fail to reject $H_0$ at level $\alpha$
:::
:::
...
2.  **Test details:** Which test, hypotheses, $\alpha$ level
...
| 14  |   8.2   |   Differences in pop prop's    |      $p_1-p_2$      |   Differences in sample proportions    | $\widehat{p}_1-\widehat{p}_2$ |